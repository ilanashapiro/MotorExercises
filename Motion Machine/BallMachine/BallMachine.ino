...
const byte ARM_HOMING_PIN = A4;
const byte LOWER_SENSOR_PIN = 57;
const byte UPPER_SENSOR_PIN = 56;

const byte microstepping = 8;
const float stepperAccelInMmpersec = 5;
const float stepperSpeedInMmpersec = 5;



//STEPPER
void homeStepper() {
  armStepper.moveToHomeInMillimeters(-1, stepperSpeedInMmpersec, 40, ARM_HOMING_PIN);
}
